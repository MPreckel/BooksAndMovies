...
export default function MovieReviewForm({ movieId, movieTitle, posterPath }: MovieReviewFormProps) {
  const { getReview, createReview, updateReview, deleteReview, loading } = useMovieReviews()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (existingReview) {
        const result = await updateReview(movieId, { 
          rating: rating || null, 
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              placeholder="¿Qué te pareció la película? Comparte tu opinión..."
